...
function World() {
  ...
  return (
    <>
      ...
      <Box at={[-3.25, 1.53, -0.55]} size={[0.94, 0.65, 0.08]} color="#464a4c" />
      <Box at={[-3.25, 1.53, -0.61]} size={[0.8, 0.51, 0.01]} color="#c5dedb" />
      <Box at={[-2.7, 1.18, -0.25]} size={[0.7, 0.05, 0.29]} color="#4e5557" />
      <group>
        <Box at={[-2.7, 0.55, -1.4]} size={[0.72, 0.12, 0.72]} color="#315b93" />
        <Box at={[-2.7, 0.98, -1.76]} size={[0.72, 0.76, 0.12]} color="#234877" />
        {[-2.98, -2.42].map((x) => (
          <Box key={x} at={[x, 0.25, -1.4]} size={[0.07, 0.55, 0.07]} color="#526b89" />
        ))}
      </group>
